...
AllTypes extends any, TypeName extends keyof Omit<AllTypes['default'], 'Timestampable'> = keyof Omit<AllTypes['default'], 'Timestampable'>, Type extends AllTypes['default'][TypeName] = AllTypes['default'][TypeName]> {
    private config;
    e: any;
    typeName: TypeName;
    eType: any;
